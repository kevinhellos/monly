    ...
    return (
        <>
            ...
            <div className="filter-container">
                <div 
                    className={`text-md mb-5 badge p-3 px-5 ${selectedFilter == "all" ? "bg-black text-white active:bg-black focus:bg-black hover:bg-black " : "hover:bg-gray-100"} py-4 cursor-pointer me-3 border border-gray-200  shadow-sm`}
                    onClick={() => {
                ...
                <div 
                    className={`text-md mb-5 badge p-3 px-5 ${selectedFilter == "today" ? "bg-black text-white  active:bg-black focus:bg-black hover:bg-black " : "hover:bg-gray-100"} py-4 cursor-pointer me-3 border border-gray-200 shadow-sm`}
                    onClick={() => {
